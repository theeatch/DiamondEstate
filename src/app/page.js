...
const projects = [
  ...
  },
  {
    ...
    imageAlt: "Project 2",
    bullets: ["3bhk", "2bhk", "ID not Mandatory Entry", "Pool, Sports"],
  },
  {
    id: 3,
...
const ProjectModal = ({ project, onClose }) => (
  ...
  >
    ...
    >
      ...
      {project.bullets.includes("2bhk") && project.bullets.includes("3bhk") ? (
        <div className="flex gap-4">
          <Button>
            <Link href="/payment2b">Buy 2BHK</Link>
          </Button>
          <Button>
            <Link href="/payment3b">Buy 3BHK</Link>
          </Button>
        </div>
      ) : project.bullets.includes("3bhk") ? (
        <Button>
          <Link href="/payment3b">Buy 3BHK</Link>
        </Button>
      ) : (
