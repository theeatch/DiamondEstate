        ...
        <>
            ...
            <div className="container flex flex-col gap-2 px-4 text-center md:gap-4 md:px-6">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8 lg:gap-10">
                <div className="flex flex-col gap-1.5">
                  <h3 className="text-4xl text-green-700 font-medium underline ">Username</h3>
                  <input 
                  type="text"
                  className="text-2xl p-2 rounded-2xl w-1/2 mx-auto"
                  value={username}
                ...
                <div className="flex flex-col gap-1.5">
                  <h3 className="text-4xl text-green-700 font-medium underline ">Member Since</h3>
                  <input
                  type="date"
          ...
          <div className="w-full py-6">
            <div className="container flex flex-col gap-2 px-4 text-center md:gap-4 md:px-6">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8 lg:gap-10">
                {/* <div className="flex flex-col gap-1.5">
                  <h3 className="text-4xl text-green-700 font-medium underline ">Flats Rented</h3>
                  <input
                    type="number"
                    className="text-2xl  p-2 rounded-xl w-1/2 mx-auto"
                ...
                <div className="flex flex-col gap-1.5">
                  <h3 className="text-4xl text-green-900 font-medium underline ">Properties Boughts</h3>
                  <div className="text-2xl pt-2">1. Mandavi Pearl City</div>
                </div>
              </div>
            </div>
          </div>
